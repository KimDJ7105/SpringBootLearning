...
public class TodoController {
    ...
    public String todoAdd(@AuthenticationPrincipal CustomUserDetails userDetails, @Valid @ModelAttribute("todo") TodoDTO todo, BindingResult result,Model model) {
        if(result.hasErrors()) {
            System.out.println(result.getAllErrors());
            return "todoAddForm";
        }

        todo.setUserid(userDetails.getUsername());
